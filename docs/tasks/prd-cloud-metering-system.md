...
| InfluxDB ✅ | 专为时序优化，压缩率高，自动降采样 | 不适合复杂关联查询 | **抄读数据** |
...
| | GET | `/api/v1/auth/codes` | 获取验证码/授权码 |
| **用户** | GET | `/api/v1/user/info` | 获取当前用户信息 |
| **项目** | GET | `/api/v1/projects` | 项目列表 |
| | POST | `/api/v1/projects` | 创建项目 |
| | GET | `/api/v1/projects/{id}` | 项目详情 |
| | PUT | `/api/v1/projects/{id}` | 更新项目 |
| | DELETE | `/api/v1/projects/{id}` | 删除项目 |
| **表计类型** | GET | `/api/v1/meter-types` | 表计类型列表 |
| **线制类型** | GET | `/api/v1/wire-types` | 线制类型列表 |
| **采集点** | GET | `/api/v1/meter-points` | 采集点配置列表 |
| **样机** | GET | `/api/v1/meters` | 样机列表 |
| | POST | `/api/v1/meters` | 样机入库 |
| | GET | `/api/v1/meters/{id}` | 样机详情 |
| | PUT | `/api/v1/meters/{id}` | 更新样机 |
| | POST | `/api/v1/meters/{id}/status` | 状态变更 |
| | PUT | `/api/v1/meters/{id}/communication` | 更新通信配置 |
| | GET | `/api/v1/meters/{id}/status-history` | 状态变更历史 |
| | GET | `/api/v1/meters/{id}/attachments` | 样机附件列表 |
| **借用** | GET | `/api/v1/meters/borrows` | 借用记录列表 |
| | POST | `/api/v1/meters/{id}/borrow` | 提交借用申请 |
| **维修** | GET | `/api/v1/meters/repairs` | 维修记录列表 |
| **采集任务** | GET | `/api/v1/tasks` | 任务列表 |
| | POST | `/api/v1/tasks` | 创建任务 |
| | GET | `/api/v1/tasks/{id}` | 任务详情 |
| | PUT | `/api/v1/tasks/{id}` | 更新任务 |
| | DELETE | `/api/v1/tasks/{id}` | 删除任务 |
| | PATCH | `/api/v1/tasks/{id}/toggle` | 启用/禁用任务 |
| | POST | `/api/v1/tasks/{id}/execute` | 立即执行 |
| | GET | `/api/v1/tasks/{id}/logs` | 执行日志 |
| **告警** | GET | `/api/v1/alarms` | 告警列表 |
| | GET | `/api/v1/alarms/stats` | 告警统计 |
| | GET | `/api/v1/alarms/{id}` | 告警详情 |
| | POST | `/api/v1/alarms/{id}/handle` | 处理告警 |
| **分析** | GET | `/api/v1/analysis/daily` | 每日分析 |
| | POST | `/api/v1/analysis/compare` | 对比分析 |
| | GET | `/api/v1/analysis/consistency` | 数据一致性 |
| | POST | `/api/v1/analysis/consistency/check` | 执行一致性检查 |
| | GET | `/api/v1/analysis/data-quality` | 数据质量统计 |
| | GET | `/api/v1/analysis/reports` | 分析报告列表 |
| **测试** | GET | `/api/v1/tests` | 测试任务列表 |
| | POST | `/api/v1/tests` | 创建测试任务 |
| | GET | `/api/v1/tests/{id}` | 测试任务详情 |
| | POST | `/api/v1/tests/{id}/defects` | 添加缺陷 |
| | GET | `/api/v1/tests/{id}/report` | 获取测试报告 |
| | POST | `/api/v1/tests/{id}/report` | 生成测试报告 |
| **缺陷** | GET | `/api/v1/defects` | 缺陷列表 |
| | PUT | `/api/v1/defects/{id}` | 更新缺陷 |
| **系统管理** | GET | `/api/v1/system/users` | 用户列表 |
...
| | GET | `/api/v1/system/db-monitor` | 数据库监控 |
| | GET | `/api/v1/system/data-archive` | 数据归档记录 |
| **大屏** | GET | `/api/v1/screens/overview` | 项目概览大屏数据 |
| | GET | `/api/v1/screens/project/{id}` | 项目详情大屏数据 |
| | GET | `/api/v1/screens/meter/{id}` | 单表监控大屏数据 |
| **通用** | POST | `/api/v1/upload` | 文件上传 |
| | GET | `/api/v1/timezone` | 获取时区 |
...
```http
GET /api/v1/alarms?page=1&page_size=20&severity=warning&is_handled=false
```
...
```json
{
  ...
  "data": {
    ...
    "is_handled": true,
    "handled_by": 5,
    "handled_at": "2026-05-14T11:00:00Z"
  }
}
```
    ...
    "meters": [
      {
        ...
        "meter_name": "Coral测试表01",
        "data_points": [
          { "time": "2026-05-13T00:00:00Z", "value": 120.5 },
          { "time": "2026-05-13T01:00:00Z", "value": 121.2 }
        ]
      }
    ]
  }
...
```http
GET /api/v1/analysis/consistency?project_id=1&date=2026-05-14
```
...
```json
{
  ...
  "data": {
    ...
    "total_meters": 50,
    "consistent_meters": 48,
    "inconsistent_meters": [
      {
        "meter_id": 125,
        "serial_number": "DLMS2024025",
        "missing_fields": ["meter_billing_profile"],
        "completeness": 85.5
      }
    ],
...
```http
GET /api/v1/analysis/data-quality?meter_id=123&start_date=2026-05-01&end_date=2026-05-14
```
...
```http
GET /api/v1/tests?page=1&page_size=20&project_id=1&status=running
```
...
```json
{
  ...
  "data": {
    "items": [
      {
        "id": 501,
        "test_name": "Coral DCSP稳定性测试",
        "test_type": "stability",
        "project_id": 1,
        "project_name": "Coral项目",
        "status": "running",
        "meter_ids": [123, 124, 125],
        "start_time": "2026-04-14T10:00:00Z",
        "expected_end_time": "2026-05-14T10:00:00Z",
        "defect_count": 3,
        "created_by": 5,
...
```json
{
  ...
  "data": {
    ...
    "status": "running",
    "meters": [
      { "id": 123, "serial_number": "DLMS2024001", "meter_type": "DCSP" }
    ],
    "start_time": "2026-04-14T10:00:00Z",
    "expected_end_time": "2026-05-14T10:00:00Z",
    "defects": [
...
```http
POST /api/v1/tests/{id}/defects
Content-Type: application/json

{
  "title": "时钟偏差超过阈值",
  "description": "测试第7天发现时钟偏差达到15秒",
  "severity": "minor",
  "meter_id": 123,
...
```http
GET /api/v1/defects?page=1&page_size=20&severity=major&status=open&project_id=1
```
...
```http
GET /api/v1/system/users?page=1&page_size=20&role=project_test_responsible
    ...
    "items": [
      {
        ...
        "roles": ["project_test_responsible"],
        "is_active": true,
        "last_login": "2026-05-14T09:30:00Z",
...
```json
{
  ...
  "data": [
    ...
    {
      "id": 3,
      "name": "project_test_responsible",
      "display_name": "项目软件测试负责人",
      "description": "项目测试执行",
      "permissions": ["meter:read", "meter:write", "task:read", "task:execute", "test:*"],
      "user_count": 10
    }
  ]
}
  ...
  "data": [
    {
      ...
      "member_count": 15,
      "children": [
        { "id": 2, "name": "电表测试组", "parent_id": 1, "member_count": 8 }
      ]
    }
  ]
}
  ...
  "data": [
    {
      ...
      "sort": 1,
      "children": [
        { "id": 11, "name": "样机列表", "path": "/meter/list", "sort": 1 },
        { "id": 12, "name": "借用管理", "path": "/meter/borrow", "sort": 2 }
      ]
    }
  ]
}
...
```json
{
  ...
  "data": {
    ...
    "components": {
      ...
      "influxdb": { "status": "up", "latency_ms": 5 }
    },
    "scheduler": {
      "active_jobs": 12,
      "next_run": "2026-05-14T10:02:00Z"
    }
  }
}
```
...
```json
{
  ...
  "data": {
    "postgresql": {
      ...
      "table_sizes": [
        { "table": "dev_meter", "size_mb": 50, "rows": 5000 },
        { "table": "col_task_log", "size_mb": 1200, "rows": 500000 }
      ]
    },
    "redis": {
      "used_memory_mb": 256,
...
```http
GET /api/v1/system/audit-logs?page=1&page_size=20&user_id=5&operation_type=UPDATE
```
    ...
    "items": [
      {
        ...
        "resource_type": "meter",
        "resource_id": 123,
        "old_values": { "current_status": "in_stock" },
        "new_values": { "current_status": "testing" },
...
```http
GET /api/v1/system/data-archive?page=1&page_size=20
```
    ...
    "energy_curves": [
      {
        ...
        "meter_name": "Coral测试表01",
        "data": [
          { "time": "2026-05-14T00:00:00Z", "value": 125.5 },
          { "time": "2026-05-14T01:00:00Z", "value": 126.1 }
        ]
      }
    ],
...
```json
{
  ...
  "data": {
    ...
    "reading_event_curve": [
      { "time": "2026-05-14T10:00:00Z", "duration_ms": 245, "success": true },
      { "time": "2026-05-14T10:02:00Z", "duration_ms": 252, "success": true }
    ],
    "last_updated": "2026-05-14T10:00:00Z"
  }
}
...
| Celery | Celery | Python 分布式任务队列（已弃用，使用APScheduler） |
| APScheduler | Advanced Python Scheduler | Python 轻量级任务调度框架 |
...
**最后更新**: 2026-05-16
**更新内容**:
- v1.2: 修复章节编号重复错乱；统一技术栈（Celery→APScheduler，移除MongoDB）；补充完整API路由汇总表；新增系统管理API（用户/角色/部门/菜单/审计/监控）、测试管理API（CRUD+缺陷）、大屏展示API（3种）；更新环境变量配置
- v1.1: 补充 API 格式、错误码、数据字典、WebSocket 设计、前端规范
